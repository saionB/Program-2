...
public class Main {
  ...
  public static void main(String[] args) throws Orders.NumberOrdersExceededException {
    ...
    while(!quit) {
      ...
      while(!valid_input) {
        try {
          displayUserOptions();
          selection = getSelection(6, input);
          valid_input  = true;
  ...
  // -----------------------------------------------------------
    ...
    try {
      ...
      menu.add(new MenuItem("Herb Chicken", "#310", "280",
                            ...
                            menu.add(new MenuItem("Sphaghetti", "#205", "300",
                            "22.50", HEART_HEALTHY)); 
                            
                            menu.add(new MenuItem("Hamburger", "#310", "450",
                            "22.50", NOT_HEART_HEALTHY));
                            
                            menu.add(new MenuItem("Tacos", "#310", "350",
                            "22.50", NOT_HEART_HEALTHY));

                            menu.add(new MenuItem("Chicken Tenders", "#310", "320",
                            "22.50", HEART_HEALTHY));

                            menu.add(new MenuItem("Cheesteak Sub", "#310", "400",
                            "22.50", NOT_HEART_HEALTHY));

                            menu.add(new MenuItem("Chicken Quesadilla", "#310", "310",
                            "22.50", HEART_HEALTHY));
    }
  ...
  // -----------------------------------------------------------
    ...
    System.out.println("  2 - Display Heart Healthy Only");
  ...
  public static void placeOrder(Menu menu, Orders orders, 
                                Scanner input) 
                        throws NumberOrdersExceededException, Orders.NumberOrdersExceededException {
  // -----------------------------------------------------------
